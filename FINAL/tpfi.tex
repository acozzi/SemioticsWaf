...
Imaginemos un escenario donde un ciber delincuente logra una forma de penetrar un sistema a partir de una vulnerabilidad (desconocida hasta el momento) del mismo. En algún momento (que puede durar entre 1 segundo y 10 años) el responsable de ese sistema lo detecta y lo reporta. En ciberseguridad, ese momento se llama zero-day, aun cuando la vulnerabilidad pueda haber existido desde tiempo atrás, se trata del día cero para el camino de soluciones posibles a ese problema.

El reporte de esa vulnerabilidad nueva, sería resuelto por una comunidad de colaboradores, en el caso de algunos proyectos de software libre o por equipos de 
